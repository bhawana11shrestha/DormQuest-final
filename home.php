...
<!--dropdown-->
    <div class="dropdown">
      ...
      <div class="dropdown-content">
       <ul>
        <li style="list-style-type:none"> <a href="userPanel2.php"> PROFILE</a></li>
        <li tyle="list-style-type:none"> <a href="logout.php"> LOGOUT</a></li>
        </ul>
        </div>
 </div>
</div>
    ...
    <div class="swiper product-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box">
                ...
                <a href="booking.php" class="btn">Book this</a>
            </div>
            <div class="swiper-slide box">
